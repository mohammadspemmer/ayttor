--Begin Tools.lua :)
local SUDO = 431714063 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@mohammadbots', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
